...
var hljs = function() {
    ...
    const U = {}
        ...
        , q = (e,n)=>{
        U[`${e}/${n}`] || (console.log(`Deprecated as of ${e}. ${n}`),
            U[`${e}/${n}`] = !0)
    }
        , H = Error();
        ...
        return e.classNameAliases = s(e.classNameAliases || {}),
            function t(i, r) {
                ...
                i.contains || (i.contains = []),
                    i.contains = [].concat(...i.contains.map((e=>(e=>(e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map((n=>s(e, {
                        variants: null
                    }, n)))),
                        e.cachedVariants ? e.cachedVariants : Q(e) ? s(e, {
                            starts: e.starts ? s(e.starts) : null
                        }) : Object.isFrozen(e) ? s(e) : e))("self" === e ? i : e)))),
    ...
    var Y = (e=>{
            ...
            function b(e, t, i, s) {
                ...
                function g() {
                    null != M.subLanguage ? (()=>{
                            ...
                            if ("string" == typeof M.subLanguage) {
                                ...
                                e = m(k, M.subLanguage.length ? M.subLanguage : null);
                ...
                function p(e, n) {
                    ...
                    e.beginScope && (e.beginScope._wrap ? (S.addKeyword(k, w.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap),
                        k = "") : e.beginScope._multi && (u(e.beginScope, n),
                        k = "")),
                        M = Object.create(e, {
                            parent: {
                                value: M
                ...
                function h(e) {
                    return 0 === M.matcher.regexIndex ? (k += e[0],
                        1) : (R = !0,
                        0)
                }
                function E(e) {
                ...
                function N(n, s) {
                    ...
                    if ("begin" === y.type && "end" === s.type && y.index === s.index && "" === o) {
                        if (k += t.slice(s.index, s.index + 1),
                            !r) {
            ...
            function m(e, t) {
                ...
                const a = (e=>{
                    ...
                    , i = t.filter(f).filter(y).map((n=>b(n, e, !1)));
                i.unshift(a);
                const s = i.sort(((e,n)=>{
                        if (e.relevance !== n.relevance)
                            return n.relevance - e.relevance;
                        if (e.language && n.language) {
                            if (f(e.language).supersetOf === n.language)
                                return 1;
                            if (f(n.language).supersetOf === e.language)
                                return -1
                        }
                        return 0
                    }
    ...
    var ze = Object.freeze({
        ...
        grmr_markdown: e=>{
            ...
            a.contains.push(i),
                i.contains.push(a);
            let s = [n, t];
            return a.contains = a.contains.concat(s),
        ...
        grmr_typescript: e=>{
            const n = {
                ...
                , i = Ee(e);
            return Object.assign(i.keywords, n),
                i.exports.PARAMS_CONTAINS.push(t),
                i.contains = i.contains.concat([t, {
                    beginKeywords: "namespace",
                    end: /\{/,
                    excludeEnd: !0
                }, {
